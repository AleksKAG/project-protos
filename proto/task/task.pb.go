...
func (x *ListTasksByUserRequest) GetPageSize() uint32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
const file_proto_task_task_proto_rawDesc = "" +
	...
	"\x0fListTasksByUser\x12\x1c.task.ListTasksByUserRequest\x1a\x1d.task.ListTasksByUserResponseB/Z-github.com/AleksKAG/project-protos/proto/taskb\x06proto3"
...
var file_proto_task_task_proto_goTypes = []any{
	...
	(*ListTasksByUserResponse)(nil), // 11: task.ListTasksByUserResponse
}
var file_proto_task_task_proto_depIdxs = []int32{
	...
	5,  // 12: task.TaskService.UpdateTask:output_type -> task.UpdateTaskResponse
	...
	11, // 15: task.TaskService.ListTasksByUser:output_type -> task.ListTasksByUserResponse
